...
const Searchbar = ({ onSearchChange }) => {
  ...
  return (
    <div className="mx-4 max-h-screen justify-between mt-4 bg-white font-sans space-x-3 flex flex-row gap-4">
      ...
      <div className="flex gap-4">
        <Link href="/bmi"><Button color="lime" radius="full" variant="solid">BMI </Button></Link>
